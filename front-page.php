...
<section id="about" class="about-section section-padding">
    ...
    <div class="container">
        <div class="about-content">
            <h2 class="about-title">Чому варто звернутись до мене?</h2>
            
            <div class="about-benefits-grid">
                <div class="about-benefit-card">
                    <p class="about-benefit-text">Більше 11 років досвіду, хірургічний досвід в США та Європі. Член Європейської асоціації урологів та Міжнародного товариства реконструктивної урології</p>
                </div>
                
                <div class="about-benefit-card">
                    <h3 class="about-benefit-title">Індивідуальний підхід</h3>
                    <p class="about-benefit-text">Кожен випадок розглядається з урахуванням ваших особливостей, забезпечуючи персоналізоване лікування для досягнення найкращого результату</p>
                </div>
                
                <div class="about-benefit-card">
                    <h3 class="about-benefit-title">Міжнародний досвід і кваліфікація</h3>
                    <p class="about-benefit-text">Мій хірургічний досвід в США та Європі дозволяє застосовувати найсучасніші методи лікування та забезпечувати високий рівень ефективності</p>
                </div>
                
                <div class="about-benefit-card">
                    <h3 class="about-benefit-title">Перевірені методи лікування</h3>
                    <p class="about-benefit-text">Я використовую лише науково обґрунтовані та ефективні протоколи лікування, що довели свою результативність у міжнародній практиці</p>
                </div>
            </div>
        </div>
    </div>
